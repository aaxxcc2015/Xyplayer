<?php
/*########################################################
# 影视CMS通用解析接口 V1.2 by http://www.haoid.cn
# 官方网站: http://www.haoid.cn
# 源码获取：http://www.haoid.cn
# 模块功能：影视CMS通用解析接口
# 更新时间：2018.11.23 
#########################################################*/
...
//seacms 查询类 by http://www.haoid.cn
class Queryclass{	
  ...
  case 1 :   //mac v10
   ...
   case 3 :   //zanpian
			 ...
			 //判断表前缀
	        if($sql_config['profix']==''){$table='zanpian_vod';}else{$table=$sql_config['profix']."vod";}
